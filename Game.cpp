...
void Game::createBalls() {
	...
	//objectManager->AddBall(100.0f, 100.0f, 30.0f, "white");
	//objectManager->AddBall(400.0f, 400.0f, 100.0f, "white");

	//objectManager->AddCircle(500.0f, 500.0f, 100.0f);
	//objectManager->AddCircle(700.0f, 900.0f, 200.0f);
	//objectManager->AddCircle(100.0f, 500.0f, 50.0f);
